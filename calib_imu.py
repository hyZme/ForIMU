...
def publish_imu(timer_event):
    ...
    accel_x_list.append(accel_x*9.8)
    accel_y_list.append(accel_y*9.8)
    accel_z_list.append(accel_z*9.8)
    ...
    gyro_x_list.append(gyro_x*0.0174)
    gyro_y_list.append(gyro_y*0.0174)
    gyro_z_list.append(gyro_z*0.0174)
    ...
    if flag_calib ==1:
        ...
        imu_msg.linear_acceleration.z = accel_z_1*9.81 - accel_x_offset
